...
const swaggerSpec = {
  ...
  paths: {
    ...
    '/requirements/{id}/bids': {
      get: { tags: ['Requirements'], summary: 'List all bids on a requirement (owning customer)', security: bearerAuth, parameters: [idParam()], responses: { 200: { description: 'Bids', content: { 'application/json': { schema: { type: 'array', items: { $ref: '#/components/schemas/Bid' } } } } }, 401: responses401, 403: responses403 } },
